...
namespace PAYROLLSYSTEM.BL
{
    ...
    {
        //-class po na pinaglalagyan po ng lahat po ng mga properties po na gamit ko po 
        // para po sa CREATEPAYROLL(gross income at net income) at tsaka sa user user inputs din po.
